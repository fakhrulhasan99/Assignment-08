        ...
        <div className='text-center w-[90%] mx-auto py-10'>
            ...
            <div className='flex justify-between py-10'>
                <div className='bg-white p-10 rounded-2xl w-1/5 text-left'>
                    <img className='w-2/3 py-5' src="/src/assets/success-doctor.png" alt="" />
                    <div ref={ref} className="max-w-full overflow-hidden text-6xl font-bold">
                ...
                <div className='bg-white p-10 rounded-2xl w-1/5 text-left'>
                    ...
                    <p className='text-2 py-5xl'>Patients</p>
                </div>
                <div className='bg-white p-10 rounded-2xl w-1/5 text-left'>
