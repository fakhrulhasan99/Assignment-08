...
const Details = () => {
    ...
    return (
        <div className='w-[90%] mx-auto'>
            ...
            <div className='flex flex-col lg:flex-row gap-10 justify-between bg-white p-10 rounded-4xl'>
                <div className='lg:w-1/2 p-4 rounded-4xl'>
                ...
                <div className='lg:w-1/2 flex flex-col justify-center'>
                    <div>
                        ...
                        <div className='text-xl py-2 flex'>
                            ...
                            <span className='flex flex-wrap pl-4 gap-8'>{Availability.map(day => <Availabilities key={day} day={day} />)}</span>
                        </div>
            ...
            <div className='bg-white my-10 p-10 rounded-4xl text-center'>
                <div className='text-center'>
                    ...
                    <div className="mt-8 border-y border-dotted flex flex-col md:flex-row justify-around p-6 text-center items-center">
